...
//            "create table " + MYDATABASE_TABLE + " (" + KEY_CONTENT + " text not null);";
    private static final String SCRIPT_CREATE_DATABASE =
            "create table "+MYDATABASE_TABLE+"(id INTEGER PRIMARY KEY AUTOINCREMENT,"+KEY_CONTENT+" text not null,"+KEY_CONTENT2+" text,"+KEY_CONTENT3+" int);";
    ...
    public String queueAll() {
        ...
        Cursor cursor = sqLiteDatabase.query(MYDATABASE_TABLE, columns, KEY_CONTENT2+"=? OR "+ KEY_CONTENT2+"=?", new String[]{"blue","red"}, null, null, KEY_CONTENT + "ASC");
        String result = "";
